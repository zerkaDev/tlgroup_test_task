...
class Command(BaseCommand):
    ...
    def create_departments(self):
        root = Department.objects.create(name='Компания', level=1)

        level_2 = [
            Department(name='Development', parent=root, level=2),
            Department(name='Sells', parent=root, level=2),
            Department(name='Admin', parent=root, level=2),
        ]
        Department.objects.bulk_create(level_2)
        ...
        Department.objects.bulk_create(level_3)
        ...
        Department.objects.bulk_create(level_4)
        ...
        Department.objects.bulk_create(level_5)
